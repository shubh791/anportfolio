    ...
    <section id="contact" className="py-32 max-w-7xl mx-auto px-8">
      ...
      <div className="flex flex-col items-center text-center mb-20">
        ...
        >
          ...
          <span className="text-[10px] font-mono text-cyan-500 uppercase tracking-widest font-bold">Network_Status: Available</span>
        </motion.div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-20">
        {socialLinks.map((link, i) => (
          <motion.a
            ...
            className="group relative p-8 bg-white/[0.02] border border-white/5 rounded-sm overflow-hidden transition-all duration-500 hover:border-cyan-500/30 hover:bg-cyan-500/[0.02]"
          >
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
              <span className={`text-2xl mb-4 text-gray-500 transition-all duration-300 group-hover:scale-110 ${link.color}`}>
                {link.icon}
              </span>
              <h3 className="text-[10px] font-mono font-black uppercase tracking-[0.3em] text-gray-400 mb-1">
                {link.name}
              </h3>
              <p className="text-xs text-white font-medium opacity-60 group-hover:opacity-100 transition-opacity">
                {link.handle}
              </p>
            </div>
          </motion.a>
      ...
      {/* NEW IMPACT CONNECT SECTION */}
      <motion.div 
        initial={{ opacity: 0 }}
        whileInView={{ opacity: 1 }}
        transition={{ duration: 1 }}
        className="flex flex-col items-center text-center border-t border-white/5 pt-20"
      >
        <p className="text-2xl md:text-3xl font-black uppercase italic tracking-tighter text-white mb-4">
          Ready to drive <span className="text-cyan-500">measurable impact?</span>
        </p>
        <p className="text-gray-500 max-w-2xl text-sm font-light leading-relaxed mb-8">
        ...
        {/* Subtle Location Tag */}
        <div className="flex items-center gap-4 text-[9px] font-mono text-gray-700 uppercase tracking-[0.4em]">
